...
export const MediaCard = memo(({ item, isPlaying, playedOnce, onPlay }: {
  item: VideoFile
  isPlaying: boolean
  playedOnce: boolean
  ...
  return (
    <div ref={ref} className="rounded-2xl overflow-hidden shadow-md bg-white relative">
      <div className="aspect-video bg-black relative">
        {inView ? (
          <ReactPlayer
            ...
            height="100%"
            config={{
              file: { attributes: { preload: 'none', poster: item.thumbnailLink } }
            }}
